    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div id="new-account-container" class="col-md-8 mt-5">
                    <!-- <form action="<php echo $_SERVER[ 'REQUEST_URI' ]; ?>" method="post" id="login-form"> -->
                    <form action="account-process.php" method="post" id="new-account-form">
                        <div id="new-account">
                        <h1>Create a New Account</h1>
                            <div class="form-group">
                                ...
                                <label>Email</label>
                                <div class="controls">
                                    <input type="text" id="account-form-email" name="email"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="password" id="account-form-password" name="password" />
                            ...
                            <div class="form-group">
                                <div class="controls">
                                    <input type="submit" id="account-form-submit" name="Log In" />
                                </div>
                            </div>
                        </div>
